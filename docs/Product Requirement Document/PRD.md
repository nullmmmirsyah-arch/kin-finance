...
> Last updated: 2026-09-08 (Add Transaction Sheet — rewrite app/transaction-form.tsx to sheet, keypad eval utils/keypadEval, note suggest hooks/useNoteSuggestions, isolated components/transaction/*; prev 2026-09-04 Household delete/leave/transfer — Account fixed icons Streamline 4 via Iconify CC BY 4.0 + Category 56 vectors — Architecture deepening Period/Time · Transactions query · Icon registry, no UX break)
...
|------|------|-------------|
| 2026-09-08 | Feature | **Add Transaction Sheet (gathering Q1A Q2B Q3A Q4A Q6A Q7C Q8B)** — rewrite `app/transaction-form.tsx` to sheet, keypad eval `utils/keypadEval`, note suggest `hooks/useNoteSuggestions`, isolated `components/transaction/*`. Updates §3.6/§8. |
